    ...
    <div className="d-flex outer-container">
        <div className="card text-center con-info">
          ...
          <ul>
            ...
            <li id='linkedin' style={styles.li}><FontAwesomeIcon icon={faLinkedin} size="lg" style={styles.icon}/><a href="https://www.linkedin.com/in/rita-pecuch" style={styles.a} >https://www.linkedin.com/in/rita-pecuch</a></li>
            <li id='github' style={styles.li}><FontAwesomeIcon icon={faGithub} size="lg" style={styles.icon}/><a href="https://github.com/rpecuch" style={styles.a} >https://github.com/rpecuch</a></li>
          </ul>
